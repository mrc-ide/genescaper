...
//------------------------------------------------
// test for collision between a point and an ellipse x and y are the coordinates
// of the point. f1 and f2 are the coordinates of the two foci of the ellipse
// and e is the eccentricity (0 = circle, 1 = line).
...
// between two points. m and k are the gradient and intercept of the infinite
// line. l1 and l2 (in both x and y) are the start- and end-points of the finite
// line. If the line does intersect then, in addition to returning true, the x-
// and y- coordinates of the intersection points is stored in [hx, hy].
...
bool collision_test_abline_ellipse(double m, double k,
  ...
  // if the descriminant of the quadratic is negative then the line does not
  ...
  // corresponding to the two points of intersection (these were passed in by
  // reference and so are part of the function output)
...
// coordinates of the two foci of the ellipse and e is the eccentricity (0 =
// circle, 1 = line). Note, this will not detect if the ellipse is completely
// inside the hex.
